...
import currencyInputFormPropertiesList from './currencyInputFormPropertiesList.json';

export const CurrencyInputFormPropertiesTable = () => {
  ...
  return (
    <Table
      columns={columns}
      pagination={false}
      dataSource={currencyInputFormPropertiesList}
