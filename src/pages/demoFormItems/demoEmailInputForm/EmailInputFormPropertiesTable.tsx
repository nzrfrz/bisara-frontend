...
import emailInputFormPropertiesList from './emailInputFormPropertiesList.json';

export const EmailInputFormPropertiesTable = () => {
  ...
  return (
    <Table
      columns={columns}
      pagination={false}
      dataSource={emailInputFormPropertiesList}
