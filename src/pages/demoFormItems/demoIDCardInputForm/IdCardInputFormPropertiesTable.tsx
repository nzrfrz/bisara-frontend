...
import IdCardInputFormPropertiesList from './idCardInputFormPropertiesList.json';

export const IdCardInputFormPropertiesTable = () => {
  ...
  return (
    <Table
      columns={columns}
      pagination={false}
      dataSource={IdCardInputFormPropertiesList}
