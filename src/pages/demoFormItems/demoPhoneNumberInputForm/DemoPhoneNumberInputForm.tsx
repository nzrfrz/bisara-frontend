...
import { PhoneNumberInputFormCodeSnippet } from "./PhoneNumberInputFormCodeSnippet";
import { PhoneNumberInputFormPropertiesTable } from "./PhoneNumberInputFormPropertiesTable";

export const DemoPhoneNumberInputForm = () => {
  const [form] = Form.useForm();
  const formUseWatch = Form.useWatch('phoneNumber', form);  
  ...
  const setTabItems: TabsProps['items'] = useMemo(() => {
    return [
      ...
      },
      {
        key: '2',
        label: 'Properties',
        children: <PhoneNumberInputFormPropertiesTable />,
      },
      {
        key: '3',
        label: 'Code',
        children: <PhoneNumberInputFormCodeSnippet />,
      },
    ]
  }, [value]);
