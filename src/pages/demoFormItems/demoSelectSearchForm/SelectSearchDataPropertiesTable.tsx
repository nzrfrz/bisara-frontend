...
import selectSearchDataPropertiesList from './selectSearchDataPropertiesList.json';

export const SelectSearchDataPropertiesTable = () => {
  ...
  return (
    <Table
      columns={columns}
      pagination={false}
      dataSource={selectSearchDataPropertiesList}
