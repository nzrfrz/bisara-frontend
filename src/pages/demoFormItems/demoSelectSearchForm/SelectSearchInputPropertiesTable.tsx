...
import selectSearchInputPropertiesList from './selectSearchInputPropertiesList.json';

export const SelectSearchInputPropertiesTable = () => {
  ...
  return (
    <Table
      ...
      dataSource={selectSearchInputPropertiesList}
    />
  );
};