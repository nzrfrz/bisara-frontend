...
import treeSelectDataPropertiesList from './treeSelectDataPropertiesList.json';

export const TreeSelectDataPropertiesTable = () => {
  ...
  return (
    <Table
      columns={columns}
      pagination={false}
      dataSource={treeSelectDataPropertiesList}
